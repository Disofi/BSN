...
<!--
<div class="row col-sm-12">
    <div class="col-sm-2" style="text-align:right">Despacho</div>
    <div class="col-sm-1">:</div>
    <div class="col-sm-4"><?php echo $razon; ?></div>
</div>
-->
<div class="row col-sm-12">
<div class="titulo_pagina"><h2 class="col-md-12">Reporte &gt; Guias</h2></div>
</div>
<?php 
	echo infGuias($fecdes,$fechas);
?>