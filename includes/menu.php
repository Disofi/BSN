...
if ($tipuser == 1)
{
	if($menuPage == 'informe-guias' || $menuPage == 'informe-guias-ver'  || $menuPage == 'informe-produccion' || $menuPage == 'informe-produccion-ver'
		...
		|| $menuPage == 'informe-seguimiento'  || $menuPage == 'informe-seguimiento-ver'|| $menuPage == 'informe-MKT'|| $menuPage == 'informe-MKT-ver' )
		{
			...
			if($menuPage == 'informe-MKT')		          		  { $cssMenu['informe']['subMenu'][2] = ' class="active"'; }
			if($menuPage == 'informe-MKT-ver')		              { $cssMenu['informe']['subMenu'][2] = ' class="active"'; }
	...
	<li class="has-sub'.$cssMenu['informe']['linkText'].'"><a href="#"><span class="strong">Informes</span></a>
		<ul'.$cssMenu['informe']['menu'].'>
			...
			<li'.$cssMenu['informe']['subMenu'][2].'><a href="index.php?mod=informe-MKT">Informe MKT</a></li>
		</ul>
	</li>';
	/*
	<li'.$cssMenu['informe']['subMenu'][0].'><a href="index.php?mod=informe-guias">Informe Guias</a></li>
