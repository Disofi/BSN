...
<div class="titulo_pagina"><h2 class="col-md-12">Informes &gt; Guias</h2></div>

<h3 class="productsForm col-md-12 borde_gris2">Informe Guias</h3>

<form name="form_informe_detalle" method="post" class="col-md-12" id="form_informe_detalle" action="index.php?mod=informe-guias-detalle">
   <div class="row">
